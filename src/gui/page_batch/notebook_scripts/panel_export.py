...
#   '.src/gui/page_batch/notebook_scripts/panel_export.py'
...
class ExportPage(wx.Panel):
    def __init__(self, parent):
        ...
        self.pageSizer.Add(boxScripts, 1, wx.ALL|wx.EXPAND, border=5)
        self.pageSizer.AddStretchSpacer()
        self.pageSizer.Add(self.btnExport, 0, wx.ALL|wx.ALIGN_RIGHT, border=10)
        self.SetSizer(self.pageSizer)

    def setMaxSpin(self, nMax):
        # TODO set this based on user input on settings page/PC settings
