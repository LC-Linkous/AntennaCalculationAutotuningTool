...
class Grid_Sweep_Panel(wx.Panel):
    def __init__(self, parent):
        ...
        self.searchType = 1                 # Random Sweep Constant
        ...
        stMinRes = wx.StaticText(boxTuning, label="Min Resolution")
        self.fieldMinRes = wx.TextCtrl(boxTuning, value=str(self.minRes), size=(self.defaultBoxWidth,-1))
        stMaxRes = wx.StaticText(boxTuning, label="Max Resolution")
        self.fieldMaxRes = wx.TextCtrl(boxTuning, value=str(self.maxRes), size=(self.defaultBoxWidth,-1))
  ...
  # tuning
        ...
        col1TuningSizer.Add(stMinRes, 0, wx.ALL, border=5)
        col1TuningSizer.AddSpacer(4)
        col1TuningSizer.Add(stMaxRes, 0, wx.ALL, border=5)
        ...
        col2TuningSizer.Add(self.fieldMinRes, 0, wx.ALL, border=3)
        col2TuningSizer.Add(self.fieldMaxRes, 0, wx.ALL, border=3)
    ...
    def getInputFields(self):
        ...
        try:
            ...
            self.minRes = self.fieldMinRes.GetValue()
            self.maxRes = self.fieldMaxRes.GetValue()
