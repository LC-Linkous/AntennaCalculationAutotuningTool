...
#   '.src/gui/page_optimizer/notebook_optimizer/optimizer_panels/swarm_settings_panels/panel_cat_quantum.py'
...
class Cat_Quantum_Panel(wx.Panel):
    def __init__(self, parent):
        ...
        col1TuningSizer.AddSpacer(4)
        col1TuningSizer.Add(stSRD, 0, wx.ALL, border=5)
        ...
        col2TuningSizer.Add(self.fieldSRD, 0, wx.ALL, border=3)  
        ...
        col3TuningSizer.AddSpacer(4)
        col3TuningSizer.Add(stBetaVal, 0, wx.ALL, border=5)
        col3TuningSizer.AddSpacer(4)
        ...
        col4TuningSizer.Add(self.fieldBetaVal, 0, wx.ALL, border=3)
    ...
    def getOptimizerInputs(self, is_surrogate=False):
        ...
        if noError == True:   
            if is_surrogate == False:
                ...
                df['optimizer_name'] = pd.Series([OPT_CAT_QUANTUM])
            else:
                ...
                df['sm_optimizer_name'] = pd.Series([OPT_CAT_QUANTUM])
