...
class Cat_Quantum_Panel(wx.Panel):
    def __init__(self, parent):
        ...
        stWeights1 = wx.StaticText(boxTuning, label="Tracing Weights")
        ...
        stMPM = wx.StaticText(boxTuning, label="Seeking Memory Pool")
        ...
        col1TuningSizer.AddSpacer(4)
        col1TuningSizer.Add(stMPM, 0, wx.ALL, border=5)
    ...
    def getOptimizerInputs(self):
        ...
        if noError == True:   
            ...
            df['mixture_ratio'] = pd.Series([self.MR])
