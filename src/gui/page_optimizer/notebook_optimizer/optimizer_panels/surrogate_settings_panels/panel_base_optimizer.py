...
#   '.src/gui/page_optimizer/notebook_optimizer/optimizer_panels/surrogate_settings_panels/panel_base_optimizer.py'
...
class BaseOptimizerPage(wx.Panel):
    def __init__(self, parent):
        ...
        self.boundary = 1 # default random
        ...
        optTypes = BASE_OPTIMIZERS_LIST # getting dictionary keys throws an err
    ...
    def set_optimizer_tuning_panel(self, txt):
        if txt == "PSO_basic":
            ...
            logger.error("ERROR in panel_base_optimizer.py unknown optimizer selected")
