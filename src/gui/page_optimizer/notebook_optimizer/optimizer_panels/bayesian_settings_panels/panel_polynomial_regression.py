...
#   '.src/gui/page_optimizer/notebook_optimizer/optimizer_panels/bayesian_settings_panels/panel_polynomial_regression.py'
...
class PolynomialRegression_Panel(wx.Panel):
    def __init__(self, parent):
        ...
        self.fieldPolyDegree = wx.TextCtrl(boxTuning, value=str(self.PR_degree), size=(self.defaultBoxWidth,-1))
    ...
    def getInputFields(self):
        ...
        try:
            ...
            self.PR_degree = self.fieldPolyDegree.GetValue()
    ...
    def getOptimizerInputs(self, is_surrogate=False):
        ...
        if noError == True:   
            ...
            df['pr_degree'] = pd.Series(self.PR_degree)    
            df['sm_model_name'] = pd.Series([SM_POLY_REGRESSION])
        return df, noError
