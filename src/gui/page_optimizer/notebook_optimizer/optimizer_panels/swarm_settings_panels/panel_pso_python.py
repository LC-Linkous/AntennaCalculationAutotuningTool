...
#   '.src/gui/page_optimizer/notebook_optimizer/optimizer_panels/swarm_settings_panels/panel_pso_python.py'
#   Class for inputs for time modulated PSO
#
...
class PSO_Python_Panel(wx.Panel):
    def __init__(self, parent):
        ...
        self.targetArr = None               # Target values for output
        self.tMod = 3                       # Time step extinction term
