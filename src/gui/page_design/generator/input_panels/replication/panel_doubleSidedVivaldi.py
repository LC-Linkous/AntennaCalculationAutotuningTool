...
#
#   Paper:
#   [2-double] A. Z. Hood, T. Karacolak and E. Topsakal, "A Small Antipodal Vivaldi Antenna for Ultrawide-Band Applications," in IEEE Antennas and Wireless Propagation Letters, vol. 7, pp. 656-660, 2008, doi: 10.1109/LAWP.2008.921352.
#
#
...
class DoubleSidedVivaldiOptionsPage(wx.Panel):
