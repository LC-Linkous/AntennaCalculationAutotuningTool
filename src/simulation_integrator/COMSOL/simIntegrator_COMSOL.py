...
#   'simulation_integrator/COMSOL/simInterator_COMSOL.py'
#   The main class for integrating AntennaCAT with COMSOL.
#   This class contains code for tracking running COMSOL multiphysics instances, 
...
from simulation_integrator.COMSOL.templateGen_Design import DesignTemplate
# from simulation_integrator.COMSOL.templateGen_ParamEdit import ParamEditTemplate
# from simulation_integrator.COMSOL.templateGen_ReportExport import ReportExportTemplate
from simulation_integrator.COMSOL.templateGen_Simulation import SimulationTemplate


import project.config.antennaCAT_config as c
# COMSOL_PATH = c.COMSOL_PATH
FREQ_PARAM_DATA = "" #i.e: ".\output\data\Terminal_S-Parameter_Rectangular-Plot.csv"
ANTENNA_PARAM_DATA = "" #".\output\data\Antenna-Parameters-Table.csv"
DEFAULT_COMSOL_PROJECT_NAME= "GeneratedProject.mph" 

COMSOL_DESIGN_CREATION_SCRIPT_NAME = "DesignCreation.mph"
COMSOL_DESIGN_EDIT_SCRIPT_NAME = "DesignEdit.mph"
COMSOL_SIMULATION_SCRIPT_NAME =  "DesignSimulation.mph"
COMSOL_PARAM_EDIT_SCRIPT_NAME = "DesignParamChange.mph"
COMSOL_REPORT_EXPORT_SCRIPT_NAME = "ReportExport.mph"


class SimIntegrator_COMSOL:
    ...
    def runWithScript(self, sim, newSession=True):
        #TODO: update with script command
    ...
    def getAntennaParameters(self, file = ANTENNA_PARAM_DATA):
        #TODO: adjust to file format for COMSOL
        data = pd.read_csv(file)
