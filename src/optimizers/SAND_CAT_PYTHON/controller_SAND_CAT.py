...
#   '.src/optimizers/SAND_CAT/controller_SAND_CAT.py'
#   Class interfacing with the SAND_CAT optimizer
#
...
#######################################################
    ...
    def unpackOptimizerParameters(self, optimizerParams, func_F):
        ...
        ## SAND_CAT_PYTHON is the base optimizer. It can have an internal optimizer solving a surrogate model approximation.
...
######################################################
    ...
    def create_internal_optimizer(self, optimizerParams):
        ...
        sm_approx, noError, errMsg = self.parent.check_model_approximator(SURROGATE_MODEL, INIT_SAMPLES, optimizerParams, is_internal_optimizer=False)
        if noError == False:
